...
class WalletPreparatorMulticore {
	...
	api::vuecashd::SyncBlocks::Response work;
	int work_counter = 0;
...
public:
	...
	~WalletPreparatorMulticore();
	void cancel_work();
	void start_work(const api::vuecashd::SyncBlocks::Response &new_work, const SecretKey &view_secret_key);
...
public:
	...
	bool sync_with_blockchain(api::vuecashd::SyncBlocks::Response &);  // We move from it
	bool sync_with_blockchain(const api::vuecashd::SyncMemPool::Response &);
