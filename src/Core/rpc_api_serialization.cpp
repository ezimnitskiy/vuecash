...
void ser_members(api::vuecashd::GetStatus::Request &v, ISeria &s) {
...
void ser_members(api::vuecashd::GetStatus::Response &v, ISeria &s) {
	ser_members(static_cast<api::vuecashd::GetStatus::Request &>(v), s);
...
void ser_members(api::vuecashd::SyncBlocks::Request &v, ISeria &s) {
...
void ser_members(api::vuecashd::SyncBlocks::Response &v, ISeria &s) {
	seria_kv("blocks", v.blocks, s);
	seria_kv("start_height", v.start_height, s);
	seria_kv("status", v.status, s);
}
void ser_members(api::vuecashd::SyncMemPool::Request &v, ISeria &s) {
	if (!s.is_input())
...
void ser_members(api::vuecashd::SyncMemPool::Response &v, ISeria &s) {
...
void ser_members(api::vuecashd::GetRandomOutputs::Request &v, ISeria &s) {
	seria_kv("amounts", v.amounts, s);
	seria_kv("outs_count", v.outs_count, s);
	seria_kv("confirmed_height_or_depth", v.confirmed_height_or_depth, s);
}
void ser_members(api::vuecashd::GetRandomOutputs::Response &v, ISeria &s) { seria_kv("outputs", v.outputs, s); }
void ser_members(api::vuecashd::SendTransaction::Request &v, ISeria &s) {
	seria_kv("binary_transaction", v.binary_transaction, s);
}
void ser_members(api::vuecashd::SendTransaction::Response &v, ISeria &s) { seria_kv("send_result", v.send_result, s); }
