...
static const float DB_COMMIT_PERIOD_VUECASHD    = 310;  // 5 minutes sounds good compromise
...
public:
	...
	bool on_wallet_sync3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::SyncBlocks::Request &&, api::vuecashd::SyncBlocks::Response &);
	bool on_sync_mempool3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::SyncMemPool::Request &&, api::vuecashd::SyncMemPool::Response &);

	api::vuecashd::GetStatus::Response create_status_response3() const;
	// json_rpc_node
	bool on_get_status3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::GetStatus::Request &&, api::vuecashd::GetStatus::Response &);
	bool on_get_random_outputs3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::GetRandomOutputs::Request &&, api::vuecashd::GetRandomOutputs::Response &);
	bool handle_send_transaction3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::SendTransaction::Request &&, api::vuecashd::SendTransaction::Response &);
	bool handle_check_send_proof3(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::CheckSendProof::Request &&, api::vuecashd::CheckSendProof::Response &);
	...
	bool on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::SubmitBlock::Request &&, api::vuecashd::SubmitBlock::Response &);
	bool on_submitblock_legacy(http::Client *, http::RequestData &&, json_rpc::Request &&,
	    api::vuecashd::SubmitBlockLegacy::Request &&, api::vuecashd::SubmitBlockLegacy::Response &);
...
protected:
	...
	struct LongPollClient {
		...
		api::vuecashd::GetStatus::Request original_get_status;
	};
	...
	class P2PClientVuecash : public P2PClientBasic {
		Node *const m_node;
...
#endif
	public:
		explicit P2PClientVuecash(Node *node, bool incoming, D_handler d_handler)
	...
	std::unique_ptr<P2PClient> client_factory(bool incoming, P2PClient::D_handler d_handler) {
		return std::make_unique<P2PClientVuecash>(this, incoming, d_handler);
	}
	...
	class DownloaderV1 {  // sync&download from legacy v1 clients
		...
		std::set<P2PClientVuecash *> m_good_clients;
		P2PClientVuecash *m_sync_client = nullptr;
	...
	public:
		...
		void on_connect(P2PClientVuecash *);
		void on_disconnect(P2PClientVuecash *);
		const std::set<P2PClientVuecash *> &get_good_clients() const { return m_good_clients; }
		void on_msg_notify_request_chain(P2PClientVuecash *, const NOTIFY_RESPONSE_CHAIN_ENTRY::request &);
		void on_msg_notify_request_objects(P2PClientVuecash *, const NOTIFY_RESPONSE_GET_OBJECTS::request &);
	...
	class DownloaderV11 {  // torrent-style sync&download from legacy v1 clients
		...
		std::map<P2PClientVuecash *, size_t> m_good_clients;  // -> # of downloading blocks
		size_t total_downloading_blocks = 0;
		std::list<P2PClientVuecash *> m_who_downloaded_block;
		P2PClientVuecash *m_chain_client = nullptr;
		...
		struct DownloadCell {
			...
			P2PClientVuecash *downloading_client = nullptr;
	...
	public:
		...
		void on_connect(P2PClientVuecash *);
		void on_disconnect(P2PClientVuecash *);
		const std::map<P2PClientVuecash *, size_t> &get_good_clients() const { return m_good_clients; }
		void on_msg_notify_request_chain(P2PClientVuecash *, const NOTIFY_RESPONSE_CHAIN_ENTRY::request &);
		void on_msg_notify_request_objects(P2PClientVuecash *, const NOTIFY_RESPONSE_GET_OBJECTS::request &);
		void on_msg_timed_sync(const CORE_SYNC_DATA &payload_data);
	};
	...
	void sync_transactions(P2PClientVuecash *);
