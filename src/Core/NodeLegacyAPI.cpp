...
bool Node::on_getblocktemplate(http::Client *who, http::RequestData &&raw_request, json_rpc::Request &&raw_js_request,
    api::vuecashd::GetBlockTemplate::Request &&req, api::vuecashd::GetBlockTemplate::Response &res) {
	api::vuecashd::GetStatus::Request sta;
...
void Node::getblocktemplate(const api::vuecashd::GetBlockTemplate::Request &req,
    api::vuecashd::GetBlockTemplate::Response &res) {
...
bool Node::on_get_currency_id(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::vuecashd::GetCurrencyId::Request && /*req*/, api::vuecashd::GetCurrencyId::Response &res) {
	res.currency_id_blob = m_block_chain.get_genesis_bid();
	return true;
}

bool Node::on_submitblock(http::Client *, http::RequestData &&, json_rpc::Request &&,
    api::vuecashd::SubmitBlock::Request &&req, api::vuecashd::SubmitBlock::Response &res) {
...
bool Node::on_submitblock_legacy(http::Client *who, http::RequestData &&rd, json_rpc::Request &&jr,
    api::vuecashd::SubmitBlockLegacy::Request &&req, api::vuecashd::SubmitBlockLegacy::Response &res) {
	if (req.size() != 1) {
		throw json_rpc::Error{CORE_RPC_ERROR_CODE_WRONG_PARAM, "Wrong param"};
	}

	api::vuecashd::SubmitBlock::Request other_req;
