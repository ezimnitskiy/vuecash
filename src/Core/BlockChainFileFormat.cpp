...
bool LegacyBlockChainReader::import_blockchain2(const std::string &coin_folder, BlockChainState &block_chain) {
	//	std::fstream ts_file("/Users/user/vuecash/timestamps.txt",
...
void LegacyBlockChainWriter::write_block(const vuecash::RawBlock &raw_block) {
	vuecash::BinaryArray ba = seria::to_binary(raw_block);
