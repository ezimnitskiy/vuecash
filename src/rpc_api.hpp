...
// bool - Bool
// Amount, SignedAmount, Height, Timestamp, UnlockMoment, Difficulty, (u)int - Number. vuecash does not use fractional
...
// vuecash does not use Null, you should specify empty Array as [], empty string as "", empty Object as {}
namespace vuecash {
namespace api {
...
enum return_code {
	VUECASHD_DATABASE_ERROR    = 101,  // We hope we are out of disk space, otherwise blockchain DB is corrupted.
	VUECASHD_ALREADY_RUNNING   = 102,
	WALLETD_BIND_PORT_IN_USE    = 103,
	VUECASHD_BIND_PORT_IN_USE  = 104,
...
// These messages encoded in JSON can be sent via http url /json_rpc3 to vuecashd rpc address:port
...
struct SyncBlocks {  // Used by walletd, block explorer, etc to sync to vuecashd
	...
	struct SyncBlock {  // Signatures are checked by vuecashd so usually they are of no interest
		api::BlockHeader header;
		vuecash::BlockTemplate
		    bc_header;  // the only method returning actual BlockHeader from blockchain, not api::BlockHeader
		std::vector<vuecash::TransactionPrefix>
...
void ser_members(vuecash::api::EmptyStruct &v, ISeria &s);
void ser_members(vuecash::api::Output &v, ISeria &s);
void ser_members(vuecash::api::BlockHeader &v, ISeria &s);
void ser_members(vuecash::api::Transfer &v, ISeria &s);
void ser_members(vuecash::api::Transaction &v, ISeria &s);
void ser_members(vuecash::api::Block &v, ISeria &s);
void ser_members(vuecash::api::Balance &v, ISeria &s);

void ser_members(vuecash::api::walletd::GetAddresses::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetViewKeyPair::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::CreateAddresses::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::CreateAddresses::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetBalance::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetBalance::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetUnspents::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetUnspents::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetTransfers::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetTransfers::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::CreateTransaction::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::CreateTransaction::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::CreateSendProof::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::CreateSendProof::Response &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetTransaction::Request &v, ISeria &s);
void ser_members(vuecash::api::walletd::GetTransaction::Response &v, ISeria &s);

void ser_members(vuecash::api::vuecashd::GetStatus::Request &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::GetStatus::Response &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SyncBlocks::Request &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SyncBlocks::SyncBlock &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SyncBlocks::Response &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SyncMemPool::Request &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SyncMemPool::Response &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::GetRandomOutputs::Request &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::GetRandomOutputs::Response &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SendTransaction::Request &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::SendTransaction::Response &v, ISeria &s);
void ser_members(vuecash::api::vuecashd::CheckSendProof::Request &v, ISeria &s);
